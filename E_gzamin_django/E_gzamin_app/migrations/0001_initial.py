    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answers', models.ManyToManyField(to='E_gzamin_app.Answer')),
                ('questions', models.ManyToManyField(to='E_gzamin_app.Question')),
        ...
        migrations.AddField(
            model_name='question',
            name='subjects',
            field=models.ManyToManyField(to='E_gzamin_app.Subject'),
        ),
        migrations.CreateModel(
            name='Group',
            fields=[
        ...
        migrations.AddField(
            model_name='answer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='E_gzamin_app.Question'),
        ),
    ]
